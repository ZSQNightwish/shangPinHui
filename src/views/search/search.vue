          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <a href="#" target="_blank"><img src="@/assets/img/search/mobile01.png"/></a>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile02.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile03.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile04.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile05.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile06.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
              ...
              <li class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/img/search/mobile01.png"/>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
